  ...
  <div class="card border-0 shadow-sm h-100">
    <div class="card-header bg-white py-3">
      <h6 class="mb-0 text-dark font-weight-bold">
        <i class="fas fa-calendar-day text-primary mr-2"></i>Selasa
      </h6>
    </div>
    <div class="card-body p-0">
      <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
          ...
          <tbody>
            @forelse ($jadwal_pelajaran_selasa as $data_jadwal_pelajaran)
              ...
              <tr>
                ...
                <td class="py-2">
                  <span
                    ...
                    - {{ date('H:i', strtotime($data_jadwal_pelajaran->jamPelajaran->jam_selesai)) }}</span>
                </td>
