            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 text-dark font-weight-bold">
                        <i class="fas fa-edit text-warning mr-2"></i>Ubah Data Mapel
                    </h5>
                </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" class="form-control border-0 bg-light shadow-none py-4"
                                value="{{ $mata_pelajaran->nama }}" id="nama" placeholder="Masukkan nama mata pelajaran..."
                                required>
                            <small class="text-muted mt-2 d-block">Terakhir diperbarui:
                                {{ $mata_pelajaran->updated_at->diffForHumans() }}</small>
                        </div>
                    </div>
