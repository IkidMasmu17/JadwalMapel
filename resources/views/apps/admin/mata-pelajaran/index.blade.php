                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <h5 class="mb-0 text-dark font-weight-bold">
                                <i class="fas fa-book text-primary mr-2"></i>Daftar Mata Pelajaran
                            </h5>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="px-4 py-3 border-bottom bg-light">
                        <div class="row">
                            <div class="col-md-4 ml-auto">
                                <form action="{{ route('admin.mata_pelajaran') }}" method="GET">
                                    <div class="input-group input-group-sm">
                                        <input type="text" name="q_nama" value="{{ $q_nama }}"
                                            class="form-control border-0 shadow-sm" placeholder="Cari mata pelajaran...">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="bg-light text-muted">
                                <tr>
                                    ...
                                    <th class="border-0 py-3 text-uppercase small font-weight-bold">Nama Mata Pelajaran</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span
                                                    class="font-weight-medium text-dark">{{ $data_mata_pelajaran->nama }}</span>
                                            </div>
                                        </td>
                                        <td class="px-4 py-3 text-right">
                                            <div class="btn-group shadow-sm mr-2">
                                                <a href="{{ route('admin.mata_pelajaran.guru_mapel', $data_mata_pelajaran->id) }}"
                                                    class="btn btn-white btn-sm border-0" title="Guru Mapel">
                                                ...
                                                <form onsubmit="deleteThis(event)"
                                                    action="{{ route('admin.mata_pelajaran.delete') }}" method="POST"
                ...
                <div class="card-footer bg-white py-3 border-top-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="small text-muted">
                            Menampilkan {{ count($mata_pelajaran) }} data dari total {{ $mata_pelajaran->total() }}
                        </div>
                        <div>
