                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <h5 class="mb-0 text-dark font-weight-bold">
                                <i class="fas fa-user-graduate text-primary mr-2"></i>Daftar Siswa
                            </h5>
                        </div>
                        <div class="col-auto">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="bg-light text-muted">
                                <tr>
                                    ...
                                    <th class="border-0 py-3 text-uppercase small font-weight-bold">Info Siswa</th>
                                    <th class="border-0 py-3 text-uppercase small font-weight-bold">NISN</th>
                                    <th class="border-0 py-3 text-uppercase small font-weight-bold">Agama</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-circle-sm bg-light-success text-success mr-3">
                                                    {{ substr($data_siswa->nama, 0, 1) }}
                                                </div>
                                                <div>
                                                    <span
                                                        class="font-weight-medium text-dark d-block">{{ $data_siswa->nama }}</span>
                                                    <small class="text-muted text-truncate d-inline-block"
                                                        style="max-width: 200px;">{{ $data_siswa->alamat }}</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="py-3 text-muted small">{{ $data_siswa->nisn }}</td>
                                        <td class="py-3">
                                            <span
                                                class="badge badge-light border px-3 py-1 text-dark">{{ $data_siswa->agama }}</span>
                                        </td>
                                        <td class="py-3 text-muted small">{{ $data_siswa->no_hp }}</td>
                                        <td class="px-4 py-3 text-right">
                                            <div class="btn-group shadow-sm">
                                                ...
                                                <form onsubmit="deleteThis(event)" action="{{ route('admin.siswa.delete') }}"
                ...
                <div class="card-footer bg-white py-3 border-top-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="small text-muted">
                            Menampilkan {{ count($siswa) }} data dari total {{ $siswa->total() }}
                        </div>
                        <div>
