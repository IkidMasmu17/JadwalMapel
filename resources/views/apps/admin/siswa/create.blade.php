                        ...
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-header bg-white py-3">
                                <h5 class="mb-0 text-dark font-weight-bold">
                                    <i class="fas fa-user-graduate text-primary mr-2"></i>Informasi Siswa
                                </h5>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="text-muted small font-weight-bold text-uppercase">NISN</label>
                                    <input type="text" name="nisn" class="form-control border-0 bg-light shadow-none"
                        ...
                        <div class="card border-0 shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">Digunakan untuk login siswa</small>
                                </div>
