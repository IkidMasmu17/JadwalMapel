                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <h5 class="mb-0 text-dark font-weight-bold">
                                <i class="fas fa-layer-group text-primary mr-2"></i>Daftar Tingkat
                            </h5>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('admin.tingkat.create') }}" class="btn btn-primary btn-sm px-3 shadow-sm">
                                <i class="fas fa-plus mr-1"></i> Tambah Tingkat
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="px-4 py-3 border-bottom bg-light">
                        <div class="row">
                            <div class="col-md-4 ml-auto">
                                <form action="{{ route('admin.tingkat') }}" method="GET">
                                    <div class="input-group input-group-sm">
                                        <input type="text" name="q_nama" value="{{ $q_nama }}"
                                            class="form-control border-0 shadow-sm" placeholder="Cari nama tingkat...">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="bg-light text-muted">
                                <tr>
                                    ...
                                    <th class="border-0 py-3 text-uppercase small font-weight-bold">Nama Tingkat</th>
                                        ...
                                        <td colspan="3" class="text-center py-5">
                                            <div class="py-3">
                                                ...
                                                <p class="text-muted font-italic mb-0">
                                                    @if ($q_nama == "")
                                                        Tidak ada data tingkat ditemukan.
                                                    @else
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="font-weight-medium text-dark">{{ $data_tingkat->nama }}</span>
                                            </div>
                                        </td>
                                        <td class="px-4 py-3 text-right">
                                            <div class="btn-group shadow-sm">
                                                ...
                                                <form onsubmit="deleteThis(event)" action="{{ route('admin.tingkat.delete') }}"
                ...
                <div class="card-footer bg-white py-3 border-top-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="small text-muted">
                            Menampilkan {{ count($tingkat) }} data dari total {{ $tingkat->total() }}
                        </div>
                        <div>
